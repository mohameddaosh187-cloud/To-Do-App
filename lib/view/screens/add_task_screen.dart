...
class _AddTaskScreenState extends State<AddTaskScreen> {
  late String dropdownButtonValue = widget.task?.status == StatusTask.pending
      ? "Pending"
      : "Done";
  late var titleTask = TextEditingController(text: widget.task?.title);
  late var desTask = TextEditingController(text: widget.task?.description);
  late int colorSelected = widget.task?.colorHex ?? 0xff2196F3;
              ...
              CustomMaterialButton.name(
                onPressed: () async {
                  ...
                  var newTask = TaskModel(
                    ...
                    status: dropdownButtonValue == "Pending" ? .pending : .done,
                    colorHex: colorSelected,
                  );
                  var saveFuture = isEditing
